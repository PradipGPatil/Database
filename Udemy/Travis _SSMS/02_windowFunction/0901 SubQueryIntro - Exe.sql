...
-- Ultimately, you should see three distinct total due amounts (i.e., the top three) for each group of like Vendor Ids. However, there could be multiple records
...
poh.Freight,
poh.TotalDue,
dense_rank()over(partition by VendorID order by totalDue desc) as number
from 
